...
describe('piece', () => {
  describe('can annotate a piece', () => {
    test('can annotate with undefined or undefined', () => {
      const piece = new Piece();
      piece.annotate(undefined);
      assert.deepEqual(piece.metadata, {});
    });

    test('can annotate with right values', () => {
      const piece = new Piece();
  ...
  test('can create a piece and place it', () => {
    const piece = new Piece();
    piece.locateAt(0, 0);
    assert.deepEqual(piece.centralAnchor, anchor(0, 0));
  });

  test('there are no inserts by default', () => {
    const piece = new Piece();
  ...
  test('can validate potential vertical matches between two matching pieces', () => {
  ...
  test('can validate potential vertical matches between two partially matching pieces', () => {
    const a = new Piece({ up: Slot, down: Tab });
  ...
  test('can validate potential horizontal matches between two matching pieces', () => {
  ...
  test('can validate potential horizontal matches between two partially matching pieces', () => {
    const a = new Piece({ left: Slot, right: Tab });
  ...
  test('can validate potential vertical matches between non matching pieces', () => {
    const a = new Piece({ up: Slot, down: Tab });
  ...
  test('can validate potential horizontal matches between non matching pieces', () => {
    const a = new Piece({ left: Slot, right: Tab });
  ...
  test('can create a piece with config', () => {
    const piece = new Piece(
      { up: Slot, left: Tab },
  ...
  test('can create a piece from a puzzle', () => {
  ...
  test('can compute diameter multiple times', () => {
  ...
  test('can override piece size with scalar', () => {
    const puzzle = new Puzzle();
    const piece = puzzle.newPiece();
  ...
  test('can create a rectangular, wide piece from a puzzle', () => {
  ...
  test('can create a rectangular, tall piece from a puzzle', () => {
  ...
  test('can check whether pieces are vertically close when overlapped', () => {
    const puzzle = new Puzzle();
  ...
  test('can check whether rectangular pieces are vertically close when overlapped', () => {
  ...
  test('can check whether pieces are horizontally close when overlapped', () => {
    const puzzle = new Puzzle();
  ...
  test('can check whether pieces are vertically close when far away', () => {
    const puzzle = new Puzzle();
  ...
  test('can check whether pieces are horizontally close when far away', () => {
    const puzzle = new Puzzle();
  ...
  test('can check whether pieces are vertically close when partially overlapped', () => {
    const puzzle = new Puzzle();
  ...
  test('can check whether pieces are horizontally close when partially overlapped', () => {
    const puzzle = new Puzzle();
  ...
  test('can check whether pieces are vertically close when close', () => {
    const puzzle = new Puzzle();
  ...
  test('knows its positive inserts positions', () => {
    const puzzle = new Puzzle();
  ...
  test('knows its negative inserts positions', () => {
    const puzzle = new Puzzle();
  ...
  test('has native connectors', () => {
    const piece = new Piece();

    assert.notEqual(piece.verticalConnector, undefined);
    assert.notEqual(piece.horizontalConnector, undefined);
  ...
  describe('connection of regular pieces', () => {
    ...
    test('checks if can connect horizontally', () => {
    ...
    test('can try to connect close pieces horizontally', () => {
      assert.notEqual(b.rightConnection, c);
      b.tryConnectHorizontallyWith(c);
      assert.equal(b.rightConnection, c);
    });

    test('can try to connect distant pieces horizontally ', () => {
    ...
    test('checks if can connect horizontally wih requirement that accepts all connections', () => {
    ...
    test('checks if can connect horizontally wih requirement that prevents all connections', () => {
    ...
    test('checks if can connect vertically', () => {
    ...
    test('can try to connect close pieces vertically', () => {
      assert.notEqual(a.downConnection, b);
      a.tryConnectVerticallyWith(b);
      assert.equal(a.downConnection, b);
    });

    test('can try to connect distant pieces vertically', () => {
    ...
    test('checks if can connect vertically wih requirement that accepts all connections', () => {
    ...
    test('checks if can connect vertically wih requirement that prevents all connections', () => {
    ...
    test('checks if rectangular pieces can connect vertically', () => {
  ...
  test('connects vertically irregular pieces', () => {
    const puzzle = new Puzzle();
  ...
  test('does not connect vertically when too away', () => {
    const puzzle = new Puzzle();
  ...
  test('connects vertically with attracts back', () => {
    const puzzle = new Puzzle();
  ...
  test('connects vertically with attracts, twice', () => {
    const puzzle = new Puzzle();
  ...
  test('does not connect horizontally when too away', () => {
    const puzzle = new Puzzle();
    ...
    assert.throws(() => a.connectHorizontallyWith(b), /Cannot connect right!/);
  });

  test('connects horizontally with attracts', () => {
    const puzzle = new Puzzle();
  ...
  test('pushes when no connections', () => {
    const puzzle = new Puzzle();
    const piece = puzzle.newPiece({ down: Tab });
  ...
  test('pushes when has connections', () => {
    const puzzle = new Puzzle();
  ...
  test('pushes when has connections and attracts', () => {
    const puzzle = new Puzzle();
  ...
  test('pushes rectangular pieces when has connections and attracts', () => {
    const puzzle = new Puzzle({ pieceRadius: { x: 2, y: 3 } });
  ...
  test('pushes with double connections', () => {
    const puzzle = new Puzzle();
  ...
  test('drags when no connections', () => {
    const puzzle = new Puzzle();
    const piece = puzzle.newPiece({ down: Tab });
  ...
  describe('drags when there are connections', () => {
    ...
    test('drags single-connection-piece to right pushing', () => {
      a.drag(10, 0);
      ...
      assert.equal(a.rightConnection, b);
      assert.equal(a.leftConnection, undefined);
      assert.equal(a.upConnection, undefined);
      assert.equal(a.downConnection, undefined);
    });

    test('drags single-connection-piece to right forcing disconnection', () => {
    ...
    test('drags single-connection-piece to left releasing', () => {
      a.drag(-10, 0);
    ...
    test('drags single-connection-piece up releasing', () => {
      a.drag(0, -10);
    ...
    test('drags single-connection-piece down releasing', () => {
      a.drag(0, 10);
    ...
    test('drags multi-connection-piece to right releasing', () => {
      c.drag(10, 0);
      ...
      assert.equal(c.rightConnection, undefined);
      assert.equal(c.leftConnection, undefined);
      assert.equal(c.upConnection, undefined);
      assert.equal(c.downConnection, undefined);
    });

    test('drags multi-connection-piece to left pushing', () => {
      c.drag(-10, 0);
    ...
    test('drags multi-connection-piece up releasing', () => {
      c.drag(0, -10);
    ...
    test('drags multi-connection-piece up, forcing connection', () => {
    ...
    test('drags multi-connection-piece down pushing', () => {
      c.drag(0, 10);
  ...
  describe('import', () => {
    test('can import piece without anchor', () => {
      const piece = Piece.import({
        centralAnchor: undefined,
        structure: '--TS',
        connections: {
          right: undefined,
          down: undefined,
    ...
    test('can import piece with connections - which are ignored', () => {
      const piece = Piece.import({
        centralAnchor: { x: 2, y: 3 },
        structure: 'TTST',
        connections: {
  ...
  describe('export', () => {
    test('can export piece without anchor', () => {
      const piece = new Piece({ up: Slot, left: Tab });
    ...
    test('can export piece without metadata', () => {
      const piece = new Piece({ up: Slot, left: Tab });
      piece.locateAt(10, 0);
    ...
    test('can export piece with metadata and anchor', () => {
      const piece = new Piece({ up: Slot, left: Tab });
      piece.locateAt(10, 0);
    ...
    test('can export piece with metadata, anchor and size', () => {
      const piece = new Piece({ up: Slot, left: Tab });
      piece.locateAt(10, 0);
      piece.annotate({ foo: 2 });
    ...
    test('can export a piece with connections without metadata', () => {
      const puzzle = new Puzzle();
    ...
    test('can export a piece with connections with metadata', () => {
      const puzzle = new Puzzle();
